function out = LoadRawDump(DumpFolder, file, varargin)
...
if (isempty(file))
    DumpFile = [DumpFolder, getlatestfile([DumpFolder '*_raw.csv'])];
end
...
data = ParseCombinedSample(dlmread(DumpFile, ','), filter_speed);
