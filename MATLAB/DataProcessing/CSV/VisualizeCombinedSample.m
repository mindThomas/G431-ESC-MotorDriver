...
DumpFolder = '../../../Python/';
data = LoadDump(DumpFolder, 'ADC_SAMPLETIME_47CYCLES_5.csv');
...
ax1 = subplot(2,1,1); plot(data.PWM_Frequency); legend('PWM Frequency');
...
function txt = currentTooltip(event_obj, target_axis, data)
    ...
    if (target_axis == event_obj.Target) || ...
        ...
        txt = {   ['Index: ',num2str(idx)],...
                  ...
                  ['Time within period: ',num2str(1000/data.PWM_Frequency(idx) * data.TriggerLocationOFF(idx) / data.TimerMax(idx)),' ms']...
                  };     
    else
